...
export class ImageCacheDbService {
  ...
  async ensureInitialized(): Promise<void> {
    ...
    try {
      ...
      this.logger.error("init failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async getAvatar(cacheKey: string): Promise<AvatarEntry | null> {
    try {
      ...
      this.logger.error("getAvatar failed", e, { source: "ImageCacheDbService" });
      return null;
    }
  }
  ...
  async setAvatar(
    ...
    try {
      ...
      this.logger.error("setAvatar failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async getEmote(emoteKey: string): Promise<EmoteEntry | null> {
    try {
      ...
      this.logger.error("getEmote failed", e, { source: "ImageCacheDbService" });
      return null;
    }
  }
  ...
  async setEmote(
    ...
    try {
      ...
      this.logger.error("setEmote failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async getBadge(badgeKey: string): Promise<BadgeEntry | null> {
    try {
      ...
      this.logger.error("getBadge failed", e, { source: "ImageCacheDbService" });
      return null;
    }
  }
  ...
  async setBadge(badgeKey: string, url: string, base64Data: string): Promise<void> {
    try {
      ...
      this.logger.error("setBadge failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async evictExpired(): Promise<void> {
    try {
      ...
      this.logger.error("evictExpired failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async evictLRU(): Promise<void> {
    try {
      ...
      this.logger.error("evictLRU failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async clearAll(): Promise<void> {
    try {
      ...
      this.logger.error("clearAll failed", e, { source: "ImageCacheDbService" });
    }
  }
  ...
  async updateStats(): Promise<void> {
    try {
      ...
      this.logger.error("updateStats failed", e, { source: "ImageCacheDbService" });
    }
  }
